...
1. **Cambio de framework** — Cambiar Flask → FastAPI sin tocar `domain/`  
1. **Migración Access progresiva** — Feature por feature, sin big bang  
1. **Trabajo paralelo** — Dev A en Clientes, Dev B en Ensayos (sin conflictos)  
1. **Reglas de negocio centralizadas** — Validaciones en `domain/models.py`  
